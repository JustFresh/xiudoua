...
<link type="text/css" rel="stylesheet" href="<%=basePath %>assets/pagecss/admin/member/preDeposit.css" />
<body>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-12 col-md-12">
						<div class="tab-nav">
							<ul class="pull-left">
								<li class="selected"><a href="javascript: void(0)"><i class="fa fa-cog"></i> 充值管理</a></li>
								<li><a href="javascript: void(0)"><i class="fa fa-cog"></i> 提现管理</a></li>
								<li><a href="javascript: void(0)"><i class="fa fa-list"></i> 预存款明细</a></li>
								<li><a href="javascript: void(0)"><i class="fa fa-list"></i> 充值卡余额明细</a></li>
								<li><a href="javascript: void(0)"><i class="fa fa-magic"></i> 调节预存款</a></li>
							</ul>
				...
				<div class="row">
					<div class="col-sm-12 col-md-12">
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<tr>
									<td>470532391088093810</td>
									<td>戏子同学</td>
									<td>2016-12-05 15:21</td>
									<td>2016-12-05 15:21</td>
									<td>支付宝</td>
									<td>￥200.00</td>
									<td>未支付</td>
