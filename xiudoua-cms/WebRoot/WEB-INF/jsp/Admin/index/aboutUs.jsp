						  	...
						  	<div class="panel-body">
								<form>
									<div class="form-group">
										...
										<input type="text" class="form-control" value="${settings.siteName }" readonly />
									</div>
									<div class="form-group">
										<label>网站LOGO<em>（如果你不知道LOGO，我只有一个大写的“服”）</em></label>
										<img src="<%=basePath %>${settings.logo }" class="logo" />
									</div>
									<div class="form-group">
										<label>备案号<em>（前台页面底部可以显示 ICP 备案信息）</em></label> 
										<input type="text" class="form-control" value="${settings.recordNumber }" readonly />
									</div>
									<div class="form-group">
										<label>客服电话<em>（显示在网站的底部）</em></label> 
										<input type="text" class="form-control" value="${settings.siteNumber }" readonly />
									</div>
									<div class="form-group">
										<label>电子邮件<em>（显示在网站的底部）</em></label> 
										<input type="text" class="form-control" value="${settings.siteEmail }" readonly />
									</div>
									<div class="form-group">
										<label>第三方统计代码<em>（前台页面底部可以显示第三方统计）</em></label> 
										<textarea rows="5" class="form-control">${settings.thirdStatistics }</textarea>
									</div>
									<div class="form-group">
